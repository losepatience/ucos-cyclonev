			 ...
			 const struct dpll_params *params)
{
	/* Setup post-dividers */
	if (params->m2 >= 0)
		writel(params->m2, (void *)dpll_regs->cm_div_m2_dpll);
	if (params->m3 >= 0)
		writel(params->m3, (void *)dpll_regs->cm_div_m3_dpll);
	if (params->m4 >= 0)
		writel(params->m4, (void *)dpll_regs->cm_div_m4_dpll);
	if (params->m5 >= 0)
		writel(params->m5, (void *)dpll_regs->cm_div_m5_dpll);
	if (params->m6 >= 0)
		writel(params->m6, (void *)dpll_regs->cm_div_m6_dpll);
}

static inline void do_lock_dpll(const struct dpll_regs *dpll_regs)
{
	clrsetbits((void *)dpll_regs->cm_clkmode_dpll,
...
static inline void enable_clock_module(u32 *const clkctrl_addr, u32 enable_mode,
				       u32 wait_for_enable)
{
	clrsetbits(clkctrl_addr, MODULE_CLKCTRL_MODULEMODE_MASK,
...
{
	clrsetbits(clkctrl_reg, CD_CLKCTRL_CLKTRCTRL_MASK,
